...
export async function getWeather(lat, lon, units = 'metric') {
    ...
    const url = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&current_weather=true&hourly=temperature_2m,relative_humidity_2m,windspeed_10m,surface_pressure&daily=temperature_2m_max,temperature_2m_min,uv_index_max&temperature_unit=${tempUnit}&windspeed_unit=${windUnit}&timezone=auto`;
